...
curl -X POST -H "Content-Type: application/json" -d '{  "name": "Sample Challenge", "description": "This is a sample challenge description", "end": "2024-01-21T15:12:54", "start": "2024-01-20T23:11:54", "free_time": 10, "blacklist": ["www.youtube.com", "www.facebook.com"] }' "http://$host:$port/create-event"
curl -X POST -H "Content-Type: application/json" -d '{  "name": "Second Challenge", "description": "This is another event description", "end": "2024-01-21T13:12:54", "start": "2024-01-20T22:11:54", "free_time": 10, "blacklist": ["www.instagram.com", "www.facebook.com"] }' "http://$host:$port/create-event"
